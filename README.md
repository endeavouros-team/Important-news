...
Date | Description
:--- | :---
2021-Apr-07 | Changed the patched `yad` package name to `yad-eos` to avoid further confusion. To use the patched yad, install `yad-eos`:<br>`sudo pacman -Syu yad-eos`
